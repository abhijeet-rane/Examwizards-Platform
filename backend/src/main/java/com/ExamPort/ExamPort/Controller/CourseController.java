        ...
        try {
            ...
            if (priceStr != null && !priceStr.trim().isEmpty()) {
                try {
                    ...
                    logger.info("Parsed price BigDecimal: {} (scale: {}, precision: {})", price, price.scale(), price.precision());
            ...
            logger.info("Saving course with price: {}", course.getPrice());
            
            // Save course
            Course savedCourse = courseRepository.save(course);
            
            logger.info("Course saved successfully. Saved price: {}", savedCourse.getPrice());
            ...
            logger.info("Response price value: {}", savedCourse.getPrice());
